...
#ifdef CYGPKG_DEVS_ETH_NIOS_OPENCORES_PHI_ETH0

//structs and tables for eth0
static oeth_info openeth_priv;
ETH_DRV_SC(oeth_sc,
           &openeth_priv,          // Driver specific data
		   CYGPKG_DEVS_ETH_NIOS_OPENCORES_PHI_ETH0_NAME, // Name for device
           openeth_start,
           openeth_stop,
           openeth_ioctl,
           openeth_can_send,
...
NETDEVTAB_ENTRY(oeth_netdev, 
                "openeth_" CYGPKG_DEVS_ETH_NIOS_OPENCORES_PHI_ETH0_NAME,
                openeth_init,
                &oeth_sc);
#endif
...
//EOF devs_eth_NIOS_opencorec_phi.inl

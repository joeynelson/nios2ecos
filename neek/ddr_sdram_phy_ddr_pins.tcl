...
set patterns [list]
lappend patterns addrcmd_2t ${instname}_alt_mem_phy_ciii_inst|adc*|addr\[*\].addr_struct|half_rate.addr_pin|auto_generated|ddio_outa\[*\]|dataout
lappend patterns addrcmd_2t ${instname}_alt_mem_phy_ciii_inst|adc*|ba\[*\].ba_struct|half_rate.addr_pin|auto_generated|ddio_outa\[*\]|dataout
lappend patterns addrcmd_2t ${instname}_alt_mem_phy_ciii_inst|adc*|cas_n_struct|half_rate.addr_pin|auto_generated|ddio_outa\[*\]|dataout
lappend patterns addrcmd_2t ${instname}_alt_mem_phy_ciii_inst|adc*|ras_n_struct|half_rate.addr_pin|auto_generated|ddio_outa\[*\]|dataout
lappend patterns addrcmd_2t ${instname}_alt_mem_phy_ciii_inst|adc*|we_n_struct|half_rate.addr_pin|auto_generated|ddio_outa\[*\]|dataout
lappend patterns addrcmd    ${instname}_alt_mem_phy_ciii_inst|adc*|cke\[*\].cke_struct|half_rate.addr_pin|auto_generated|ddio_outa\[0\]|dataout
lappend patterns addrcmd    ${instname}_alt_mem_phy_ciii_inst|adc*|cs_n\[*\].cs_n_struct|half_rate.addr_pin|auto_generated|ddio_outa\[0\]|dataout
...
set outputFileName "ddr_sdram_phy_autodetectedpins.tcl"
...
set ddr_sdram_phy_use_high_performance_timing 1
if {[namespace which -variable ::override_ddr_sdram_phy_use_high_performance_timing] != ""} {
  set ddr_sdram_phy_use_high_performance_timing $::override_ddr_sdram_phy_use_high_performance_timing
}

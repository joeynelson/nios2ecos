...
// ============================================================
// Megafunction Name(s):
// 			ddr_sdram_phy_alt_mem_phy_ciii
// ============================================================
// Generated by altmemphy 8.0 [Altera, IP Toolbench 1.3.0 Build 230]
// ************************************************************
...
module ddr_sdram_phy (
	...
	ddr_sdram_phy_alt_mem_phy_ciii	ddr_sdram_phy_alt_mem_phy_ciii_inst(
	...
	defparam
		ddr_sdram_phy_alt_mem_phy_ciii_inst.ADDR_CMD_2T_EN = 1,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.ADDR_CMD_ADD_1T = "FALSE",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.ADDR_CMD_NEGEDGE_EN = "TRUE",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.ADDR_COUNT_WIDTH = 4,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.CAPTURE_MIMIC_PATH = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.CLOCK_INDEX_WIDTH = 3,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.DDR_MIMIC_PATH_EN = 1,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.DEDICATED_MEMORY_CLK_EN = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.DLL_EXPORT_IMPORT = "EXPORT",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.DQS_PHASE_SETTING = 2,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.DQS_PHASE = 6000,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.DWIDTH_RATIO = 4,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.FAMILY = "Cyclone III",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_TCL = "3.0",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.GENERATE_WRITE_DQS = 1,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.LOCAL_IF_CLK_PS = 15037,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.LOCAL_IF_AWIDTH = 22,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.LOCAL_IF_BURST_LENGTH = 1,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.LOCAL_BURST_LEN_BITS = 1,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.LOCAL_IF_DWIDTH = 64,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.LOCAL_IF_DRATE = "HALF",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.LOCAL_IF_TYPE_AVALON_STR = "true",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_ADDR_CMD_BUS_COUNT = 1,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_MEMTYPE = "DDR",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_DWIDTH = 16,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_BE_WIDTH = 8,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_DQS_WIDTH = 2,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_ROWADDR_WIDTH = 13,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_BANKADDR_WIDTH = 2,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_CS_WIDTH = 1,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_DM_WIDTH = 2,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_DM_PINS_EN = 1,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_DQSN_EN = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_OCT_EN = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_DQ_PER_DQS = 8,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_DQS_CAPTURE_EN = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_POSTAMBLE_EN_WIDTH = 2,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_CLK_PS = 7518,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MIMIC_DEBUG_EN = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MIMIC_PATH_TRACKING_EN = 1,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.NUM_MIMIC_SAMPLE_CYCLES = 6,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.NUM_DEBUG_SAMPLES_TO_STORE = 4096,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.ODT_ADD_1T = "FALSE",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.PLL_EXPORT_IMPORT = "NONE",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.MEM_IF_CLK_PS_STR = "7518 ps",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.PLL_REF_CLK_PS = 20000,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.PLL_STEPS_PER_CYCLE = 64,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.PLL_TYPE = "ENHANCED",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.POSTAMBLE_INITIAL_LAT = 16,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.POSTAMBLE_AWIDTH = 6,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.POSTAMBLE_CALIBRATION_AND_SETUP_EN = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.POSTAMBLE_HALFT_EN = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.POSTAMBLE_RESYNC_LAT_CTL_EN = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.RDP_INITIAL_LAT = 6,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.RDP_RESYNC_LAT_CTL_EN = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.RESYNC_CALIBRATION_AND_SETUP_EN = 1,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.RESYNC_CALIBRATE_ONLY_ONE_BIT_EN = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.RESYNC_PIPELINE_DEPTH = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.READ_LAT_WIDTH = 5,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.TRAINING_DATA_WIDTH = 32,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.SCAN_CLK_DIVIDE_BY = 2,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.USE_MEM_CLK_FOR_ADDR_CMD_CLK = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.ADDR_CMD_ADD_INTERMEDIATE_REGS = "FALSE",
		ddr_sdram_phy_alt_mem_phy_ciii_inst.QDRII_MEM_DLL_NUM_CLK_CYCLES = 2048,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.PLL_RECONFIG_PORTS_EN = 0,
		ddr_sdram_phy_alt_mem_phy_ciii_inst.REG_DIMM = 0;
endmodule
...
// Retrieval info: <MEGACORE title="ALTMEMPHY"  version="8.0"  build="198"  iptb_version="1.3.0 Build 230"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="ddr_sdram_phy_alt_mem_phy_ciii" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="ddr_sdram_phy_alt_mem_phy_sequencer_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="ddr_sdram_phy_alt_mem_phy_sequencer_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr_sdram_phy_alt_mem_phy_delay;+ddr_sdram_phy_alt_mem_phy_sequencer_wrapper;+ddr_sdram_phy_alt_mem_phy_reconfig_ciii;+ddr_sdram_phy_alt_mem_phy_pll_ciii --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\tore\zylin\ecosboard\ecosboard\fw\nios_standard/ddr_sdram_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="ddr_sdram_phy_gb.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "quartus_settings">
// Retrieval info:      <PRIVATE name = "DEVICE" value="EP3C25F324C8"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "FAMILY" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>

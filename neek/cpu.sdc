...
set_false_path -from sld_hub:sld_hub_inst|sld_dffex*|Q* -to *$cpu_jtag_sysclk_path|ir*
set_false_path -from sld_hub:sld_hub_inst|sld_jtag_state_machine:jtag_state_machine|state[1] -to *$cpu_oci_debug_path|monitor_go
